...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="home.jsp">Bolsa Empleo</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" action="Ctrl_Login" method="POST" style="color:white">
            Bienvenido: 
            <a href="perfil.jsp"><%= sesion.getAttribute("usuario")%></a>

            <button type="submit" name="btn_cerrar" class="btn btn-outline-success my-2 my-sm-0" >Cerrar Sesion</button>
        </form>
    </div>
</nav>  
